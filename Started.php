...
<main>
<div>
<h2 style='text-align: center' >View All Started Tasks</h2>
<table>
	<tr>
		<th>Task ID</th>
		<th>Name</th>
	...
	$sql = "SELECT * FROM task, status, duedate WHERE task.taskID = status.taskID AND task.taskID = dueDate.taskID AND status = 'Started' GROUP BY task.taskID";
